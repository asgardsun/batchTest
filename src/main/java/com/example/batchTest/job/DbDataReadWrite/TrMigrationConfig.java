package com.example.batchTest.job.DbDataReadWrite;



import com.example.batchTest.domain.Accounts;
import com.example.batchTest.domain.Orders;
import com.example.batchTest.repository.AccountsRepository;
import com.example.batchTest.repository.OrdersRepository;
 ...
 * run : --spring.batch.job.names=trMigraionJob
 */
@Configuration
